...
.field private static args_types:[Ljava/lang/Class;

.field private static args_val:[Landroid/content/Context;

.field private static mBrowserMgmtClassType:Ljava/lang/Class;

.field private static mBrowserMgmtInst:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/webkit/WebViewClassic;->mBrowserMgmtClassType:Ljava/lang/Class;

    sput-object v0, Landroid/webkit/WebViewClassic;->mBrowserMgmtInst:Ljava/lang/Object;

    sput-object v0, Landroid/webkit/WebViewClassic;->args_types:[Ljava/lang/Class;

    sput-object v0, Landroid/webkit/WebViewClassic;->args_val:[Landroid/content/Context;
...
.method public constructor <init>(Landroid/webkit/WebView;Landroid/webkit/WebView$PrivateAccess;)V
    ...
    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectCursorLeft:Landroid/graphics/Point;

    new-instance v1, Landroid/webkit/QuadF;

    invoke-direct {v1}, Landroid/webkit/QuadF;-><init>()V

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectCursorLeftTextQuad:Landroid/webkit/QuadF;

    new-instance v1, Landroid/graphics/Point;

    invoke-direct {v1}, Landroid/graphics/Point;-><init>()V

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectCursorRight:Landroid/graphics/Point;

    new-instance v1, Landroid/webkit/QuadF;

    invoke-direct {v1}, Landroid/webkit/QuadF;-><init>()V

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectCursorRightTextQuad:Landroid/webkit/QuadF;
    ...
    iput-boolean v5, p0, Landroid/webkit/WebViewClassic;->mFirstPaint:Z

    const-string v1, "/system/framework/browsermanagement.jar"

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->BrowserMgmtPluginName:Ljava/lang/String;

    const-string v1, "com.android.qualcomm.browsermanagement.BrowserManagement"

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->BrowserMgmtClassName:Ljava/lang/String;
    ...
    new-instance v1, Landroid/webkit/WebViewClassic$SendScrollToWebCore;

    invoke-direct {v1, p0, v6}, Landroid/webkit/WebViewClassic$SendScrollToWebCore;-><init>(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewClassic$1;)V

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSendScroll:Landroid/webkit/WebViewClassic$SendScrollToWebCore;
    ...
    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mHandleAlpha:Landroid/webkit/WebViewClassic$SelectionHandleAlpha;
    ...
    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mHandleAlphaAnimator:Landroid/animation/ObjectAnimator;
    ...
    const-string v1, "browser.multitab.management"

    invoke-static {v1, v5}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    iput-boolean v1, p0, Landroid/webkit/WebViewClassic;->mIsMultitabManagementOn:Z

    const-string v1, "browser.management"
    ...
    invoke-direct {p0, v1}, Landroid/webkit/WebViewClassic;->setupBrowserMgmtPlugin(Landroid/content/Context;)V
...
.method static synthetic access$5100(Landroid/webkit/WebViewClassic;)Landroid/webkit/HTML5VideoViewManager;
    .locals 1
    .parameter "x0"
...
.method private destroyNative()V
    ...
    .local v1, nptr:I
    iput v3, p0, Landroid/webkit/WebViewClassic;->mNativeClass:I
    ...
    invoke-static {v1}, Landroid/webkit/WebViewClassic;->nativeDestroy(I)V

    sget-object v2, Landroid/webkit/WebViewClassic;->mBrowserMgmtClassType:Ljava/lang/Class;
    ...
    sget-object v4, Landroid/webkit/WebViewClassic;->args_types:[Ljava/lang/Class;

    invoke-virtual {v2, v3, v4}, Ljava/lang/Class;->getMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v2

    sget-object v3, Landroid/webkit/WebViewClassic;->mBrowserMgmtInst:Ljava/lang/Object;
    ...
    sget-object v6, Landroid/webkit/WebViewClassic;->args_val:[Landroid/content/Context;
    ...
    new-instance v3, Landroid/webkit/WebViewClassic$DestroyNativeRunnable;

    invoke-direct {v3, v1}, Landroid/webkit/WebViewClassic$DestroyNativeRunnable;-><init>(I)V
...
.method private handleTouchEventCommon(Landroid/view/MotionEvent;III)V
    ...
    .local v14, contentY:I
    sget-object v3, Landroid/webkit/WebViewClassic;->mBrowserMgmtClassType:Ljava/lang/Class;
    ...
    sget-object v5, Landroid/webkit/WebViewClassic;->args_types:[Ljava/lang/Class;

    invoke-virtual {v3, v4, v5}, Ljava/lang/Class;->getMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v3

    sget-object v4, Landroid/webkit/WebViewClassic;->mBrowserMgmtInst:Ljava/lang/Object;
    ...
    sget-object v7, Landroid/webkit/WebViewClassic;->args_val:[Landroid/content/Context;
    ...
    const-string v5, "method not found: PageTouched "
    ...
    .end local v29           #shiftedX:I
    .end local v30           #shiftedY:I
    :pswitch_1
    move-object/from16 v0, p0
    ...
    .end local v25           #keepScrollBarsVisible:Z
    .end local v27           #roundedDeltaX:I
    .end local v28           #roundedDeltaY:I
    :pswitch_2
    invoke-direct/range {p0 .. p0}, Landroid/webkit/WebViewClassic;->endScrollEdit()V
...
.method private setupBrowserMgmtPlugin(Landroid/content/Context;)V
    ...
    sget-object v2, Landroid/webkit/WebViewClassic;->mBrowserMgmtInst:Ljava/lang/Object;
    ...
    const-string v2, "/system/framework/browsermanagement.jar"
    ...
    .local v1, pluginClassLoader:Ldalvik/system/PathClassLoader;
    const-string v2, "com.android.qualcomm.browsermanagement.BrowserManagement"

    invoke-virtual {v1, v2}, Ldalvik/system/PathClassLoader;->loadClass(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Landroid/webkit/WebViewClassic;->mBrowserMgmtClassType:Ljava/lang/Class;
    ...
    sput-object v2, Landroid/webkit/WebViewClassic;->mBrowserMgmtInst:Ljava/lang/Object;

    const/4 v2, 0x1

    new-array v2, v2, [Ljava/lang/Class;

    sput-object v2, Landroid/webkit/WebViewClassic;->args_types:[Ljava/lang/Class;

    const/4 v2, 0x1

    new-array v2, v2, [Landroid/content/Context;

    sput-object v2, Landroid/webkit/WebViewClassic;->args_val:[Landroid/content/Context;

    sget-object v2, Landroid/webkit/WebViewClassic;->args_types:[Ljava/lang/Class;
    ...
    const-string v3, "BrowserMgmt First Instance  "

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0

    .end local v1           #pluginClassLoader:Ldalvik/system/PathClassLoader;
    :goto_0
    sget-object v2, Landroid/webkit/WebViewClassic;->mBrowserMgmtClassType:Ljava/lang/Class;

    if-eqz v2, :cond_0

    sget-object v2, Landroid/webkit/WebViewClassic;->args_val:[Landroid/content/Context;
    ...
    const-string v4, "BrowserMgmt Instance failed "
    ...
    const-string v3, "BrowserMgmt Instance already available "
    ...
    const-string v4, "method not found: Init "
...
.method public onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    :cond_0
    sget-object v1, Landroid/webkit/WebViewClassic;->mBrowserMgmtClassType:Ljava/lang/Class;
    ...
    sget-object v3, Landroid/webkit/WebViewClassic;->args_types:[Ljava/lang/Class;
    ...
    sget-object v5, Landroid/webkit/WebViewClassic;->args_val:[Landroid/content/Context;
    ...
    const-string v3, "method not found: FocusChanged "
...
.method onPageFinished(Ljava/lang/String;)V
    ...
    iput-boolean v2, p0, Landroid/webkit/WebViewClassic;->mInPageLoadWindow:Z
    ...
    const-string v3, "method not found: PageLoadFinished "
...
.method onPageStarted(Ljava/lang/String;)V
    ...
    iput-boolean v7, p0, Landroid/webkit/WebViewClassic;->mInPageLoadWindow:Z
    ...
    :goto_0
    iput-boolean v7, p0, Landroid/webkit/WebViewClassic;->mFirstPaint:Z
    ...
    const-string v3, "method not found: PageLoadStarted "
...
.method public onResume()V
    ...
    invoke-static {v1, v3}, Landroid/webkit/WebViewClassic;->nativeSetPauseDrawing(IZ)V
    ...
    const-string v3, "method not found: ViewResumed "
...
.method public onScrollChanged(IIII)V
    ...
    invoke-virtual {v1, v2}, Landroid/webkit/WebViewClassic$SendScrollToWebCore;->send(Z)V
...
.method setBaseLayer(IZZ)V
    ...
    :cond_2
    sget-object v0, Landroid/webkit/WebViewClassic;->mBrowserMgmtClassType:Ljava/lang/Class;

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Landroid/webkit/WebViewClassic;->mFirstPaint:Z
    ...
    sget-object v1, Landroid/webkit/WebViewClassic;->mBrowserMgmtInst:Ljava/lang/Object;
    ...
    sget-object v4, Landroid/webkit/WebViewClassic;->args_val:[Landroid/content/Context;
    ...
    :goto_3
    iput-boolean v8, p0, Landroid/webkit/WebViewClassic;->mFirstPaint:Z

    goto :goto_0

    .end local v5           #scrollingLayer:I
    .end local v7           #queueFull:Z
    :cond_3
    move v5, v8
    ...
    const-string v2, "method not found: WebviewLoaded "
